...
composition_scott_low_sat = compute_cell_composition_from_growth_modulation(fitted_pars_low_asat, data_scott);
composition_scott_high_sat = compute_cell_composition_from_growth_modulation(fitted_pars_high_asat, data_scott);
% output 
...
composition_basan_low_asat = compute_cell_composition_from_growth_modulation(fitted_pars_low_asat, data_basan);
composition_basan_high_asat = compute_cell_composition_from_growth_modulation(fitted_pars_high_asat, data_basan);
% output
...
composition_si_low_asat = compute_cell_composition_from_growth_modulation(fitted_pars_low_asat, data_si);
composition_si_high_asat = compute_cell_composition_from_growth_modulation(fitted_pars_high_asat, data_si);
% output
...
% compute composition
composition_taheri = compute_cell_composition_from_growth_modulation(fitted_pars, data_taheri);
composition_taheri_low_asat = compute_cell_composition_from_growth_modulation(fitted_pars_low_asat, data_taheri);
composition_taheri_high_asat = compute_cell_composition_from_growth_modulation(fitted_pars_high_asat, data_taheri);
% output
...
% compute composition
composition_basan_si_taheri = compute_cell_composition_from_growth_modulation(fitted_pars, data_basan_si_taheri);
composition_basan_si_taheri_low_asat = compute_cell_composition_from_growth_modulation(fitted_pars_low_asat, data_basan_si_taheri);
composition_basan_si_taheri_high_asat = compute_cell_composition_from_growth_modulation(fitted_pars_high_asat, data_basan_si_taheri);
% output
