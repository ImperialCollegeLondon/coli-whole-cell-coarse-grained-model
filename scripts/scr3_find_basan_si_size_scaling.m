...
writetable(table(best_scaling_si_to_basan), '../results-data/res3_basan-2015-si-2017-scale-normalized/fitted_scaling_si_to_basan.csv');   
...
writetable(table(growth_rate_per_hr, cell_size, nutrient_type, cm_type, useless_type), ...
 '../results-data/res3_basan-2015-si-2017-scale-normalized/basan-2015-si-2017_normalized_data.csv');
