...
for i_data=1:1
    ...
    hs(1) = plot(best_pred_data.growth_rate_per_hr(I_nut_basan), best_pred_data.(fields{i_data})(I_nut_basan), 'go', 'MarkerSize', mk_size, 'MarkerFaceColor', 'g'); hold on;
    plot(best_pred_data.growth_rate_per_hr(I_nut_si), best_pred_data.(fields{i_data})(I_nut_si), 'gs', 'MarkerSize', mk_size, 'MarkerFaceColor', 'g'); hold on;
    plot(best_pred_data.growth_rate_per_hr(I_nut_taheri), best_pred_data.(fields{i_data})(I_nut_taheri), 'g^', 'MarkerSize', mk_size, 'MarkerFaceColor', 'g'); hold on;
    
    hs(2) = plot(best_pred_data.growth_rate_per_hr(I_cm_basan), best_pred_data.(fields{i_data})(I_cm_basan), 'bo', 'MarkerSize', mk_size, 'MarkerFaceColor', 'b'); hold on;
    plot(best_pred_data.growth_rate_per_hr(I_cm_si), best_pred_data.(fields{i_data})(I_cm_si), 'bs', 'MarkerSize', mk_size, 'MarkerFaceColor', 'b'); hold on;
    
    hs(3) = plot(best_pred_data.growth_rate_per_hr(I_useless_basan), best_pred_data.(fields{i_data})(I_useless_basan), 'ro', 'MarkerSize', mk_size, 'MarkerFaceColor', 'r'); hold on;
    ...
    if i_data==1
        ...
        grey = [1 1 1].* 0.5;
        plot(1+0.1,14,'o', 'MarkerSize', mk_size, 'Color', grey, 'MarkerFaceColor', grey);
        text(1.12+0.1,14,'Basan et al. (2015)','FontSize',txt_fsize);

        plot(1+0.1,13.2,'s', 'MarkerSize', mk_size, 'Color', grey, 'MarkerFaceColor', grey);
        text(1.12+0.1,13.2,'Si et al. (2017)','FontSize',txt_fsize);

        plot(1+0.1,12.4,'^', 'MarkerSize', mk_size, 'Color', grey, 'MarkerFaceColor', grey);
        text(1.12+0.1,12.4,'Taheri-Araghi et al. (2015)','FontSize',txt_fsize);    
    end
