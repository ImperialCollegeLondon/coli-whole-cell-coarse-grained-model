...
%%
single_sector = readtable('../results-data/resXX_scott-2010-model_basan-2015-si-2017-taheri-2015-fit/single-sector-size-predictions-R2-values_.csv','ReadRowNames',true);
two_sectors = readtable('../results-data/resXX_scott-2010-model_basan-2015-si-2017-taheri-2015-fit/two-sectors-size-predictions-R2-values_.csv','ReadRowNames',true);

%%s
all_V = [];
for s={single_sector} %, two_sectors, three_sectors}
    ss = s{1};
...
for i_V_fX = 2
    ...
    for i_pred=1:height(data)
        ...
        pred_data = readtable(['../results-data/resXX_scott-2010-model_basan-2015-si-2017-taheri-2015-fit/' pred_name '_data' data_type '_' pred_type '/predictions.csv']);
        pred_formula = fileread(['../results-data/resXX_scott-2010-model_basan-2015-si-2017-taheri-2015-fit/' pred_name '_data' data_type '_' pred_type '/formula.txt']);
        ...
        if i_plot > n_plots_per_fig
            ...
            export_fig(gcf,['../figure-assembly/sup-figure-XX-scott-2010-model-components/all-size-pred_' pred_type '_panel-' num2str(i_panel) '.pdf']);
            close;
            i_plot = 1;
            i_panel = i_panel + 1;
        end
        ...
        if i_pred == height(data)
            set(gcf,'Position',figsize,'Color','w');
            export_fig(gcf,['../figure-assembly/sup-figure-XX-scott-2010-model-components/' data_type '-pred_' pred_type '_panel-' num2str(i_panel) '.pdf']);
            close;
        end
