...
%%
single_sector = readtable('../results-data/res4_basan-2015-si-2017-taheri-2015-fit/single-sector-size-predictions-R2-values_ref.csv','ReadRowNames',true);
two_sectors = readtable('../results-data/res4_basan-2015-si-2017-taheri-2015-fit/two-sectors-size-predictions-R2-values_ref.csv','ReadRowNames',true);
three_sectors = readtable('../results-data/res4_basan-2015-si-2017-taheri-2015-fit/three-sectors-size-predictions-R2-values_ref.csv','ReadRowNames',true);
...
for i_V_fX = 1:2
    ...
    for i_pred=1:height(data)
        ...
        pred_data = readtable(['../results-data/res4_basan-2015-si-2017-taheri-2015-fit/ref/' pred_name '_data' data_type '_' pred_type '/predictions.csv']);
        pred_formula = fileread(['../results-data/res4_basan-2015-si-2017-taheri-2015-fit/ref/' pred_name '_data' data_type '_' pred_type '/formula.txt']);
        ...
        if i_plot > n_plots_per_fig
            ...
            export_fig(gcf,['../figure-assembly/sup-figure-XX-components/all-size-pred_' pred_type '_panel-' num2str(i_panel) '.pdf']);
            close;
            i_plot = 1;
            i_panel = i_panel + 1;
        end
