...
for i=1:2
    ...
    legend({'Basan et al. 2015', 'Si et al. 2017', 'Taheri-Araghi et al. 2015'},'Location','NorthWest');
end
...
export_fig(gcf,'../figure-assembly/sup-figure-2-components/sup_figure_2_all.pdf');
close all;