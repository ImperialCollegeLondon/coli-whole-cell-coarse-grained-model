...
model_data = readtable('../results-data/resXX_coreg-model_cell-compositions/scott_2010_modulations.csv');
...
figure(1);
export_fig(gcf,'../figure-assembly/sup-figure-XX-coreg-components/panel_nut_cm.pdf');
figure(2);
export_fig(gcf,'../figure-assembly/sup-figure-XX-coreg-components/panel_useless.pdf');
close all;
